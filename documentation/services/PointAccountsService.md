...
| [PointAccount_PointDefinition](#pointaccount_pointdefinition) | ## Gets a point account matched with the pointDefinitionId |
...
|[PointAccount_AddPointTransactions](#pointaccount_addpointtransactions)| ## Point transactions being sent to a contacts specified point account, the endpoint will able to take max 1000 transaction rows.
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
