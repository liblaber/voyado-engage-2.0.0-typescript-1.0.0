import { z } from 'zod';
import { multichannelPromotionModelStatus } from './multichannel-promotion-model-status';
import {
 ...
 */
export const multichannelPromotionModel: any = z.lazy(() => {
  return z.object({
    id: z.string(),
    status: multichannelPromotionModelStatus.optional(),
...
/**
 * 
 * @typedef  {MultichannelPromotionModel} multichannelPromotionModel   
 * @property {string} - Internal Id in Voyado
 * @property {MultichannelPromotionModelStatus} - Current status of the promotion
 ...
 */
export type MultichannelPromotionModel = z.infer<typeof multichannelPromotionModel>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const multichannelPromotionModelResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.string(),
      status: multichannelPromotionModelStatus.optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const multichannelPromotionModelRequest: any = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
      status: multichannelPromotionModelStatus.nullish(),
