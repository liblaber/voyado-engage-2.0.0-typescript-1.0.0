 ...
 */
export const promotionBasicPresentationModel = z.object({
 ...
 */
export const promotionBasicPresentationModelResponse = z
  .object({
    heading: z.string().optional(),
    description: z.string().optional(),
    link: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const promotionBasicPresentationModelRequest = z
