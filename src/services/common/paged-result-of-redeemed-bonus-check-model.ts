 ...
 */
export const pagedResultOfRedeemedBonusCheckModel = z.object({
 ...
 */
export const pagedResultOfRedeemedBonusCheckModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pagedResultOfRedeemedBonusCheckModelRequest = z
  .object({
