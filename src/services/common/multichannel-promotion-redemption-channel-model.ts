 ...
 */
export const multichannelPromotionRedemptionChannelModel = z.object({
  type_: multichannelPromotionRedemptionChannelModelType.optional(),
 ...
 */
export const multichannelPromotionRedemptionChannelModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const multichannelPromotionRedemptionChannelModelRequest = z
  .object({
    type_: multichannelPromotionRedemptionChannelModelType.nullish(),
