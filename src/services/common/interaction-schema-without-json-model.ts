 ...
 */
export const interactionSchemaWithoutJsonModel = z.object({
 ...
 */
export const interactionSchemaWithoutJsonModelResponse = z
  .object({
    id: z.string().optional(),
    displayName: z.string().optional(),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const interactionSchemaWithoutJsonModelRequest = z
