 ...
 */
export const assignDateRange = z.object({
  unit: unit,
 ...
 */
export const assignDateRangeResponse = z
  .object({
    unit: unit,
    amount: z.number().gte(1).lte(2147483647),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const assignDateRangeRequest = z
  .object({ unit: unit.nullish(), amount: z.number().nullish() })
  .transform((data) => ({
    unit: data['unit'],
    amount: data['amount'],
  }));
