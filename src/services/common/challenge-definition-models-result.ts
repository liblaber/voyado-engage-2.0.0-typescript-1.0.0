 ...
 */
export const challengeDefinitionModelsResult = z.object({
 ...
 */
export const challengeDefinitionModelsResultResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const challengeDefinitionModelsResultRequest = z
  .object({
