 ...
 */
export const pagedResultOfBonusPointTransactionModel = z.object({
 ...
 */
export const pagedResultOfBonusPointTransactionModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pagedResultOfBonusPointTransactionModelRequest = z
  .object({
