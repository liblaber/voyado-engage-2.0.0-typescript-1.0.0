 ...
 */
export const pagedResultOfAvailableLoyaltyBarClaimModel = z.object({
 ...
 */
export const pagedResultOfAvailableLoyaltyBarClaimModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pagedResultOfAvailableLoyaltyBarClaimModelRequest = z
  .object({
