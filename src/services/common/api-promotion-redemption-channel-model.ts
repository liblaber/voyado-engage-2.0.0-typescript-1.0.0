 ...
 */
export const apiPromotionRedemptionChannelModel = z.object({
  type_: apiPromotionRedemptionChannelModelType.optional(),
 ...
 */
export const apiPromotionRedemptionChannelModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const apiPromotionRedemptionChannelModelRequest = z
  .object({
    type_: apiPromotionRedemptionChannelModelType.nullish(),
