 ...
 */
export const addCheckpointToChallengeAssignmentResult = z.object({
 ...
 */
export const addCheckpointToChallengeAssignmentResultResponse = z
  .object({
    missingContactIds: z.array(z.string()).optional(),
    missingDefinitionIds: z.array(z.string()).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const addCheckpointToChallengeAssignmentResultRequest = z
  .object({
