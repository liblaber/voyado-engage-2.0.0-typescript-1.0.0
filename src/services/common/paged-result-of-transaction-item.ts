 ...
 */
export const pagedResultOfTransactionItem = z.object({
 ...
 */
export const pagedResultOfTransactionItemResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pagedResultOfTransactionItemRequest = z
  .object({
