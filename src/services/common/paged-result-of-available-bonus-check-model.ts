 ...
 */
export const pagedResultOfAvailableBonusCheckModel = z.object({
 ...
 */
export const pagedResultOfAvailableBonusCheckModelResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pagedResultOfAvailableBonusCheckModelRequest = z
  .object({
