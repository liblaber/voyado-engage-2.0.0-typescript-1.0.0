 ...
 */
export const unregisteredFromOnlineRegisterInformation = z.object({
 ...
 */
export const unregisteredFromOnlineRegisterInformationResponse = z
  .object({
    reason: z.string().optional(),
    date: z.string().optional(),
    newSocialSecurityNumber: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const unregisteredFromOnlineRegisterInformationRequest = z
